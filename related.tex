...
\FIXED{Aviv \emph{et al.} conducted a large user study on Android graphical password~\cite{Aviv2014Understanding}. They analyzed the user's security and usability preference using six visual features of pattern locks such as pattern length, number of crosses, etc.
Based on this study, they developed a brutal-force based algorithm to
