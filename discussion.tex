...
\begin{figure}[!t]
        ...
        effectiveness of the video-based attack described in this work.
          ...
          \FIXME{Replace (b) with an actual trajectory tracked by the computer vision algorithm. Keep (c) and (d) as examples
        of adding random pattern structures. Adapt the text in the paragraph.}
