...
\begin{figure}[!t]
        ...
        In order to increase the number of candidate patterns, a previously unvisited dot, such as the smaller dot in (a) or (c), can be bypassed if it is part of a horizontal, vertical or diagonal line segment of the pattern.}
