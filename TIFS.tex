...
\author{Guixin Ye, Zhanyong Tang, Dingyi Fang, Xiaojiang Chen,
    ...
    \thanks{
            ...
            \FIXED{(1)	It quantifies the security of locking patterns which are frequently used by users, showing that 
             the frequently used patterns are unreliable under video-side channel attacks (section~\ref{sec:overall_rate});}
