...
a limit set of scenarios due \FIXED{to} two reasons: (1) the complex setup of the attacking environment and (2) the WiFi signal can be disrupted by any moving
...
text-based passwords. Some of the early work in this area \FIXED{relys} on video
