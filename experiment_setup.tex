...
\section{Experimental Setup \label{sec:setup}}
    ...
    \FIXED{Like the pattern meter method proposed in~\cite{sun2014dissecting}, Song Meter~\cite{Song2015On} and Andriotis Meter~\cite{Andriotis2014Complexity} also tried to measure the complexity score of pattern locks. They have the same conclusion that more complex structure makes the pattern more complex. We illustrate this using Aviv's guessing metrics algorithm~\cite{Heidt2016Refining} to guess our collected pattern locks. Figure}
